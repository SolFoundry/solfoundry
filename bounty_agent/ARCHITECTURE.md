...
│ │       │ │ │        ││  │          │ │ │       │ │
│ │GitHub │ │ │Dept    ││  │N+ agents │ │ │gh pr  │ │
│ │Search │ │ │Mapping ││  │M gateways│ │ │create │ │
│ └───────┘ │ └────────┘│  └──────────┘ │ └───────┘ │
└───────────┴───────────┴───────────────┴──────────┘
```
...
## Agent Architecture (Multi-Agent Cluster)
...
Operations       │   7   │ GW-1,2  │ glm-5.1
```

## Gateway Topology

```
GW-1:18789 ─┬─ Security (agents)
             └─ Operations (agents)
GW-2:18790 ─┬─ Research (agents)
             └─ Operations (agents)
GW-3:18801 ─── Research (agents)
GW-4:18792 ─── Code (agents)
GW-5:18793 ─── Code (agents)
GW-6:18794 ─── Knowledge (agents)
GW-7:18795 ─── Security (agents)
```
...
graph TB
    subgraph Dashboard["BountyAgentDashboard.tsx (1060 lines)"]
        ...
        AgentGrid["Agent Status Grid<br/>N+ agents, 5 departments"]
