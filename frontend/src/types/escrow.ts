/**
 * Escrow types for bounty escrow integration with the Solana program.
 * Covers all escrow states, transaction flows, and API response shapes.
 * @module types/escrow
 */
...
export interface EscrowAccount {
  /** The on-chain PDA address for this escrow account. */
