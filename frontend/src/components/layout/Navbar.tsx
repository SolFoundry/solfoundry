      ...
      <div className="max-w-7xl mx-auto h-full px-3 sm:px-4 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-4 lg:gap-8 min-w-0">
          <Link to="/" className="flex items-center gap-2.5 group min-w-0">
            ...
            />
            <span className="font-display text-base sm:text-lg font-semibold text-text-primary tracking-wide max-[380px]:hidden">
              SolFoundry
            </span>
          </Link>
        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          ...
          {isAuthenticated && user ? (
            ...
            >
              ...
              <span className="sm:hidden max-[380px]:hidden">Sign in</span>
            </button>
          )}
