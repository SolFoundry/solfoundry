        ...
        <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
          ...
          {isAuthenticated && user ? (
            ...
            <button
              ...
              className="min-h-11 inline-flex items-center gap-2 px-3 sm:px-4 py-2 rounded-lg bg-forge-800 border border-border hover:border-border-hover text-text-primary text-sm font-medium transition-all duration-200 hover:bg-forge-700"
            >
              <GitHubIcon />
            ...
            <div className="px-4 py-4 flex flex-col gap-1">
              {NAV_LINKS.map((link) => (
                <Link
                  ...
                  className="min-h-11 px-4 py-3 rounded-lg text-sm font-medium text-text-secondary hover:text-text-primary hover:bg-forge-850 transition-colors duration-150"
                >
                  {link.label}
                </Link>
              ))}
