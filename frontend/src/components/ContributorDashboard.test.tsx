...
describe('ContributorDashboard', () => {
  ...
  describe('Rendering', () => {
    ...
    it('renders quick action buttons', () => {
      ...
      expect(screen.getByRole('button', { name: '馃攳 Browse Bounties' })).toBeInTheDocument();
      expect(screen.getByRole('button', { name: '馃弳 View Leaderboard' })).toBeInTheDocument();
      expect(screen.getByRole('button', { name: '馃挵 Check Treasury' })).toBeInTheDocument();
    });
    ...
    it('renders active bounties section', () => {
      ...
      expect(screen.getByText('GitHub 鈫?Platform Bi-directional Sync')).toBeInTheDocument();
    });
  ...
  describe('Quick Actions', () => {
    it('calls onBrowseBounties callback when Browse Bounties is clicked', () => {
      ...
      fireEvent.click(screen.getByRole('button', { name: '馃攳 Browse Bounties' }));
    ...
    it('calls onViewLeaderboard callback when View Leaderboard is clicked', () => {
      ...
      fireEvent.click(screen.getByRole('button', { name: '馃弳 View Leaderboard' }));
    ...
    it('calls onCheckTreasury callback when Check Treasury is clicked', () => {
      ...
      fireEvent.click(screen.getByRole('button', { name: '馃挵 Check Treasury' }));
