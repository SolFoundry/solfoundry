    ...
    <div className="bg-white dark:bg-surface-100 rounded-xl p-5 border border-gray-200 hover:border-gray-300 dark:border-white/5 dark:hover:border-white/10 transition-colors shadow-sm dark:shadow-none">
      <div className="flex items-center justify-between mb-3">
        <Tooltip content={tooltip ?? label} position="top">
          <span className="text-gray-600 dark:text-gray-400 text-sm cursor-help">
            {label}
            {tooltip && (
              <svg
                aria-hidden="true"
                className="inline-block ml-1 w-3.5 h-3.5 text-gray-400 dark:text-gray-500 align-middle"
                fill="none"
                viewBox="0 0 24 24"
                strokeWidth={2}
                stroke="currentColor"
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              <SummaryCard
                ...
                tooltip="Cumulative $FNDRY tokens earned from all completed and paid bounties on your account."
                icon={
              ...
              <SummaryCard
                ...
                tooltip="Number of bounties you currently have claimed or in progress. Completing these earns you $FNDRY rewards."
                icon={
              ...
              <SummaryCard
                ...
                suffix="$FNDRY"
                tooltip="$FNDRY locked in escrow for submitted or under-review work. Released to your wallet once the bounty is approved."
                icon={
                  <svg className="w-5 h-5 text-yellow-400" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
              ...
              <SummaryCard
                ...
                trend="up"
                trendValue="Top 20%"
                tooltip="Your standing on the contributor leaderboard based on completed bounties, quality scores, and earned $FNDRY. Higher tiers unlock larger bounties."
                icon={
                  <svg className="w-5 h-5 text-yellow-400" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
