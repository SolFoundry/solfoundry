          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              <SummaryCard
                ...
                tooltip="Total $FNDRY tokens earned from all completed and paid bounties."
                icon={
              ...
              <SummaryCard
                ...
                tooltip="Bounties you're currently working on or have claimed."
                icon={
              ...
              <SummaryCard
                ...
                suffix="$FNDRY"
                tooltip="$FNDRY tokens earned but not yet transferred to your wallet."
                icon={
                  <svg className="w-5 h-5 text-yellow-400" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
              ...
              <SummaryCard
                ...
                trend="up"
                trendValue="Top 20%"
                tooltip="Your position on the leaderboard based on completed bounties, review scores, and contribution history."
                icon={
                  <svg className="w-5 h-5 text-yellow-400" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
