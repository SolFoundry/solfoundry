...
/** Info circle icon used as a visual cue that a tooltip is available. */
function InfoIcon() {
  return (
    <svg
...
interface SummaryCardProps {
  ...
  trendValue?: string;
  /** Tooltip explanation text shown on hover/tap. */
  tooltip?: string;
}
  ...
  return (
    <div className="bg-white dark:bg-surface-100 rounded-xl p-5 border border-gray-200 hover:border-gray-300 dark:border-white/5 dark:hover:border-white/10 transition-colors shadow-sm dark:shadow-none">
      <div className="flex items-center justify-between mb-3">
        <span className="text-gray-600 dark:text-gray-400 text-sm flex items-center gap-1.5">
          {tooltip ? (
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <SummaryCard
                ...
                tooltip="Number of bounties you are currently working on"
                icon={
              ...
              <SummaryCard
                ...
                suffix="$FNDRY"
                tooltip="$FNDRY tokens awaiting escrow release"
                icon={
                  <svg className="w-5 h-5 text-yellow-400" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
              ...
              <SummaryCard
                ...
                trend="up"
                trendValue="Top 20%"
                tooltip="Your ranking among all contributors based on completed work"
                icon={
                  <svg className="w-5 h-5 text-yellow-400" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
