          ...
          <div className="relative max-w-2xl">
            ...
            {searchQuery && (
              <button
                ...
                className="absolute right-2 top-1/2 inline-flex h-7 w-7 -translate-y-1/2 items-center justify-center rounded-md text-text-muted transition-colors duration-150 hover:bg-forge-800 hover:text-text-primary"
              >
                <X className="h-4 w-4" />
              </button>
            )}
