...
export function BountyCard({ bounty }: BountyCardProps) {
  ...
  return (
    ...
    >
      ...
      {/* Row 4: Reward + Meta */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mt-3 pr-0 sm:pr-20">
      ...
      {/* Status badge */}
      <span className={`mt-3 sm:mt-0 sm:absolute sm:bottom-4 sm:right-5 text-xs font-medium inline-flex items-center gap-1 ${statusColor}`}>
