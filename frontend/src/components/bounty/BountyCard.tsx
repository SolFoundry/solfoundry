...
export function BountyCard({ bounty }: BountyCardProps) {
  ...
  return (
    <motion.div
      ...
      className="relative flex h-full flex-col rounded-xl border border-border bg-forge-900 p-4 sm:p-5 cursor-pointer transition-colors duration-200 overflow-hidden group"
    >
      {/* Row 1: Repo + Tier */}
      ...
      {/* Status badge */}
      <span className={`mt-3 text-xs font-medium inline-flex items-center gap-1 self-start sm:self-end ${statusColor}`}>
