...
export function BountyCard({ bounty }: BountyCardProps) {
  ...
  return (
    <motion.div
      ...
      className="relative rounded-xl border border-border bg-forge-900 p-4 cursor-pointer transition-colors duration-200 overflow-hidden group w-full max-w-md"
    >
      {/* Row 1: Repo + Tier */}
