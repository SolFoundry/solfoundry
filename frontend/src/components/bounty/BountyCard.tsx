...
export function BountyCard({ bounty }: BountyCardProps) {
  ...
  return (
    ...
    >
      ...
      {/* Row 4: Reward + Meta */}
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mt-3 pb-6 sm:pb-0">
        <span className="font-mono text-lg font-semibold text-emerald break-words">
