...
export function BountyCard({ bounty }: BountyCardProps) {
  ...
  return (
    ...
    >
      ...
      {/* Row 4: Reward + Meta */}
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between mt-3 pb-5 sm:pb-0">
      ...
      {/* Status badge */}
      <span className={`absolute bottom-3 right-4 sm:bottom-4 sm:right-5 text-xs font-medium inline-flex items-center gap-1 ${statusColor}`}>
