/**
 * EscrowDepositModal — Confirmation modal for depositing $FNDRY tokens into a bounty escrow.
 ...
 * - Touch-friendly button targets (min-h 44px)
 * - Safe-area viewport padding
 * - Touch manipulation for no 300ms delay
      ...
      >
        ...
        <div className="bg-gray-800 rounded-lg p-4 mb-6 space-y-2">
          <div className="flex justify-between text-sm">
            ...
            <span
              className={hasInsufficientBalance ? 'text-red-400 font-medium' : 'text-white'}
        ...
        {hasInsufficientBalance && (
          ...
          >
            <p className="text-red-400 text-xs font-medium">
              Insufficient balance. You need {Math.ceil(amount - (balance || 0)).toLocaleString()} more $FNDRY
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="flex-1 py-3 rounded-lg bg-gradient-to-r from-purple-600 to-green-500 text-white font-bold hover:from-purple-500 hover:to-green-400 transition-all disabled:opacity-50 disabled:cursor-not-allowed min-h-[44px] touch-manipulation active:scale-[0.98]"
