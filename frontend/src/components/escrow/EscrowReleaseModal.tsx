 ...
 * and requires explicit confirmation before signing the release transaction.
 *
 ...
 * the transaction in their wallet to complete the release.
 */
      ...
      >
        ...
        <div className="bg-yellow-900/20 border border-yellow-700/30 rounded-lg p-3 mb-6">
          <p className="text-yellow-400 text-xs leading-relaxed">
            This action is irreversible. Once released, the $FNDRY tokens will be
            transferred from the escrow account to the contributor's wallet. Only proceed
        ...
        <div className="flex gap-3">
          ...
          <button
            type="button"
            onClick={onConfirm}
            className="flex-1 py-3 rounded-lg bg-green-600 text-white font-bold hover:bg-green-500 transition-colors min-h-[44px]"
