...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center px-3 sm:px-4 pt-24 pb-16 overflow-hidden">
      {/* Background layers */}
      ...
      >
        ...
        <div className="p-4 sm:p-5 font-mono text-xs sm:text-sm leading-relaxed">
          <div className="overflow-hidden">
            ...
            <span className="text-text-secondary overflow-hidden whitespace-nowrap inline-block align-bottom max-w-[calc(100%-1rem)] animate-typewriter">
      ...
      <motion.h1
        ...
        className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-text-primary tracking-wider text-center leading-tight mt-10"
      >
      ...
      <motion.div
        ...
        className="flex flex-col sm:flex-row sm:flex-wrap items-stretch sm:items-center justify-center gap-3 sm:gap-4 mt-8 w-full sm:w-auto"
      >
        <motion.div variants={buttonHover} initial="rest" whileHover="hover" whileTap="tap" className="w-full sm:w-auto">
          <Link
            to="/bounties"
            className="w-full sm:w-auto px-6 py-3 rounded-lg bg-emerald text-text-inverse font-semibold text-sm text-center hover:bg-emerald-light transition-colors duration-200 shadow-lg shadow-emerald/20 inline-block"
          >
            Browse Bounties
          </Link>
        </motion.div>
        ...
        <motion.div variants={buttonHover} initial="rest" whileHover="hover" whileTap="tap" className="w-full sm:w-auto">
          <Link
            to="/bounties/create"
            className="w-full sm:w-auto px-6 py-3 rounded-lg border border-emerald text-emerald font-semibold text-sm text-center hover:bg-emerald-bg transition-colors duration-200 inline-block"
          >
            Post a Bounty
          </Link>
        </motion.div>
        ...
        {!isAuthenticated && (
          <motion.div variants={buttonHover} initial="rest" whileHover="hover" whileTap="tap" className="w-full sm:w-auto">
            <button
              ...
              className="w-full sm:w-auto px-6 py-3 rounded-lg border border-border text-text-secondary font-medium text-sm hover:border-border-hover hover:text-text-primary transition-all duration-200 inline-flex items-center justify-center gap-2"
            >
              <GitHubIcon /> GitHub
            </button>
          </motion.div>
      ...
      <motion.div
        ...
        className="flex flex-wrap items-center justify-center gap-x-3 gap-y-2 sm:gap-x-6 mt-8 px-2 font-mono text-xs sm:text-sm text-text-muted"
      >
        <span>
