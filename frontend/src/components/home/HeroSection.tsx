      ...
      >
        ...
        <div className="p-4 sm:p-5 font-mono text-xs sm:text-sm leading-relaxed">
          <div className="overflow-hidden">
            ...
            <span className="text-text-secondary inline-block max-w-[calc(100%-1.25rem)] overflow-hidden break-all whitespace-normal sm:break-normal sm:whitespace-nowrap sm:animate-typewriter align-top">
