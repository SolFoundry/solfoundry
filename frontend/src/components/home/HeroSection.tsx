...
import { ForgeVisualization3D } from './ForgeVisualization3D';
...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center px-4 pt-24 pb-16 overflow-hidden">
      ...
      {/* 3D Forge Visualization — Bounty #865 */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[55%] h-full opacity-80 pointer-events-none">
          <ForgeVisualization3D className="w-full h-full" />
        </div>
      </div>
