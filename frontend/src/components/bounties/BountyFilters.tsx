      ...
      <div className="relative" ref={suggestionsRef}>
        <div className="relative flex items-center">
          ...
          <input
            ...
            className="w-full rounded-lg border border-gray-200 dark:border-surface-300 bg-white dark:bg-surface-50 pl-10 pr-20 py-2.5 text-sm text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:border-solana-green/50 transition-colors"
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        {hasActive && (
          <button
            ...
            className="rounded-lg border border-gray-200 dark:border-surface-300 px-3 py-1.5 text-sm text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors"
