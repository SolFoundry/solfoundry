...
const C: Record<BountyStatus, [string, string, string]> = { open: ['Open', 'bg-[#14F195]', 'text-[#14F195]'], 'in-progress': ['In Progress', 'bg-yellow-400', 'text-yellow-400'], completed: ['Completed', 'bg-gray-500', 'text-gray-500'] };
