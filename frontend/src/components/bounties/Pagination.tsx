    ...
    <div className="mt-8 space-y-3" data-testid="pagination">
      ...
      <nav className="flex items-center justify-center gap-1" aria-label="Pagination">
        <button
          ...
          className="rounded-lg px-3 py-1.5 text-xs text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-surface-200 disabled:opacity-30 disabled:cursor-not-allowed focus:outline-none focus-visible:ring-2 focus-visible:ring-solana-green/50 transition-colors"
      ...
      {totalPages > 5 && (
        <div className="flex items-center justify-center gap-2" data-testid="go-to-page">
          ...
          <input
            ...
            className="w-16 rounded-lg border border-gray-200 dark:border-surface-300 bg-white dark:bg-surface-50 px-2 py-1 text-xs text-gray-900 dark:text-white text-center focus:outline-none focus:border-solana-green/50 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
          ...
          <button
            ...
            onClick={handleGoTo}
            disabled={!goToValue}
            className="rounded-lg px-2 py-1 text-xs text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-surface-200 disabled:opacity-30 disabled:cursor-not-allowed focus:outline-none focus-visible:ring-2 focus-visible:ring-solana-green/50 transition-colors"
