          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 sm:p-6">
              <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-4">
                ...
                {bounty.category && (
                  <span className="px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-medium bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300">
                    {bounty.category}
                  </span>
                )}
              </div>
              ...
              {githubUrl && (
                <a
                  ...
                  className="inline-flex items-center gap-2 mt-4 text-sm text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors min-h-[44px] px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800"
                >
            ...
            {bounty.deadline && (
              <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 sm:p-6">
                <h2 className="text-lg font-semibold text-gray-600 dark:text-gray-300 mb-2">Time Remaining</h2>
            ...
            {/* Description */}
            <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 sm:p-6">
              <h2 className="text-lg font-semibold text-gray-600 dark:text-gray-300 mb-4">Description</h2>
            ...
            {bounty.requirements && bounty.requirements.length > 0 && (
              <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 sm:p-6">
                <h2 className="text-lg font-semibold text-gray-600 dark:text-gray-300 mb-4">Requirements</h2>
            ...
            {canSubmit && (
              showSubmitForm ? (
                ...
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 sm:p-6 text-center">
                  <button
            ...
            {bounty.activities && bounty.activities.length > 0 && (
              <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 sm:p-6">
                <h2 className="text-lg font-semibold text-gray-600 dark:text-gray-300 mb-4">Activity</h2>
              ...
              <div className="space-y-3 pt-4">
                ...
                {githubUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block w-full bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-900 dark:text-white py-3 sm:py-4 rounded-lg font-medium transition-colors text-center min-h-[44px] touch-manipulation"
                  >
                    View on GitHub
                  </a>
                )}
