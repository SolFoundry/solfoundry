...
const ContributorAnalyticsPageRoute = lazy(() => import('./pages/ContributorAnalyticsPage'));
    ...
    >
      ...
      <Suspense fallback={<LoadingSpinner />}>
        <Routes>
          ...
          <Route path="/analytics/contributors/:username" element={<ContributorAnalyticsPageRoute />} />
