...
const RepoMarketplacePage = React.lazy(() => import('./pages/RepoMarketplacePage').then((m) => ({ default: m.RepoMarketplacePage })));
  ...
  return (
    <Suspense fallback={<PageLoader />}>
      <Routes>
        ...
        <Route path="/repos" element={<RepoMarketplacePage />} />
