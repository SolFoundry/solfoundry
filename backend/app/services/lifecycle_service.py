...
# ---------------------------------------------------------------------------
# Upstream lifecycle logging service
# ---------------------------------------------------------------------------
# Provides a separate in-memory audit trail using the upstream
# LifecycleEventType / BountyLifecycleLogDB schema (submissions, reviews,
# payouts, disputes).  Coexists with the state-machine above.
# ---------------------------------------------------------------------------

from app.models.lifecycle import (  # noqa: E402
    LifecycleEventType,
    LifecycleLogEntry,
...
def reset_store() -> None:
    """Clear all in-memory lifecycle log data. Used by tests."""
    with _lifecycle_log_lock:
