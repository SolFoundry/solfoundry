...
from app.services.solana_indexer import periodic_solana_poll
...
async def lifespan(app: FastAPI):
    ...
    # Start Solana event indexer (polls every 30 seconds)
    solana_indexer_task = asyncio.create_task(periodic_solana_poll(interval_seconds=30))
...
# Event Indexer REST API: /api/v1/*
app.include_router(indexer_router, prefix="/api")

# Event Indexer WebSocket: /ws/indexer
app.include_router(indexer_ws_router)
