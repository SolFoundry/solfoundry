...
TAGS_METADATA = [
    ...
    {"name": "sybil-protection", "description": "Anti-gaming and sybil detection: heuristics, alerts, appeals"},
...
# Sybil Protection: /api/sybil/*
app.include_router(sybil_router, prefix="/api")
