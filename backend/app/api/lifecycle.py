...
from app.models.lifecycle import ClaimRequest, ReleaseClaimRequest, WebhookTransitionRequest
...
def _ok(r):
    """Unpack (data, error); raise on error."""
    d, e = r
    if e:
        raise HTTPException(status_code=404 if "not found" in e.lower() else 400, detail=e)
    return d
